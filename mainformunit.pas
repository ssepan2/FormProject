...
begin
   try
       try
          ...
          ssepan_laz_application.StartProgressBarWithPicture(sStatusMessage, sErrorMessage, True, 0, lblStatusMessage, lblErrorMessage, ProgressBar);//, sbFileNew.Images[0].Image, True, 33);
