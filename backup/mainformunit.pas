...
begin
   try
    ...
    //use progress bar (marquee) with action icon (where available) in status bar
    StartProgressBarWithPicture(sStatusMessage, sErrorMessage, True, False, 0, 100, lblStatusMessage, lblErrorMessage, ProgressBar, imgActionIcon, sbAbout.Glyph);//, sbFileNew.Images[0].Image, True, 33);
